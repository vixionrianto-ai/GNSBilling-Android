...
class RouterRepository {
    ...
    suspend fun updateProfile(routerId: Int, profile: String, name: String, localAddress: String, remoteAddress: String, rateLimit: String, onlyOne: String) = RetrofitClient.api.updateProfile(routerId, profile, name, localAddress, remoteAddress, rateLimit, onlyOne)
