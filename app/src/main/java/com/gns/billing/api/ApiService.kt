...
interface ApiService {
    ...
    @FormUrlEncoded @POST("router/{id}/ppp-secret") suspend fun createSecret(@Path("id") id: Int, @Field("username") username: String, @Field("password") password: String, @Field("service") service: String, @Field("profile") profile: String): MessageResponse
    ...
    @FormUrlEncoded @PUT("router/{id}/ppp-secret/{secret}") suspend fun updateSecret(@Path("id") id: Int, @Path("secret") secret: String, @Field("username") username: String, @Field("password") password: String, @Field("service") service: String, @Field("profile") profile: String, @Field("disabled") disabled: String): MessageResponse
