...
interface ApiService {
    ...
    @PUT("pelanggan/{id}")
    suspend fun updatePelanggan(@Path("id") id: Int, @Body request: PelangganRequest): PelangganDetailResponse
    ...
    @PUT("paket/{id}")
    suspend fun updatePaket(@Path("id") id: Int, @Body request: PaketRequest): Paket

    @DELETE("paket/{id}")
    suspend fun hapusPaket(@Path("id") id: Int): MessageResponse
